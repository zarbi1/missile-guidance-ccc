...
function main_page.Launch_main_ui(monitor, pitch_telemetry, roll_telemetry, gyro_telemetry)
    ...
    if isConnected then
        ...
        btnStart = mainFrame:addButton({
            ...
            launch_proc.Start_procedure(mainFrame, onCoordinatesLocked)
        end)
        ...
        -- Reconnect Button
        btnReconnect = mainFrame:addButton({
            x = 2,
            y = 8,
            width = 17,
            height = 1,
            ...
            systemStatusVal.text = "Reconnecting..."
            basalt.stop()
            main_page.Launch_main_ui(monitor, pitch_telemetry, roll_telemetry, gyro_telemetry)
        end)
    end
